...
const SHOULD_MATCH_LIST = [
  ...
  [2,2,1,1,2,1,2,1,2,1,2,1,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',2,1,1,2,2,2,1,1,1],
  [2,2,1,1,2,1,2,1,2,1,1,2,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',2,1,1,2,2,2,1,1,1],
  [2,2,1,1,2,1,2,1,2,1,2,1,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',1,1,2,2,2,2,1,1,1],
  [2,2,1,1,2,1,2,1,2,1,2,1,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',1,2,1,2,2,2,1,1,1],
  [2,2,1,1,2,1,2,1,2,1,2,1,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',2,1,1,2,2,1,2,1,1],
  [2,2,1,1,2,1,2,1,2,1,2,1,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',2,1,1,2,1,2,2,1,1],
  [2,2,1,1,2,1,2,1,2,1,1,2,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',1,1,2,2,2,2,1,1,1],
  [2,2,1,1,2,1,2,1,2,1,1,2,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',1,2,1,2,2,2,1,1,1],
  [2,2,1,1,2,1,2,1,2,1,1,2,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',2,1,1,2,2,1,2,1,1],
  [2,2,1,1,2,1,2,1,2,1,1,2,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',2,1,1,2,1,2,2,1,1],
  [2,2,1,1,2,1,2,1,2,1,2,1,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',1,1,2,2,2,1,2,1,1],
  [2,2,1,1,2,1,2,1,2,1,2,1,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',1,1,2,2,1,2,2,1,1],
  [2,2,1,1,2,1,2,1,2,1,2,1,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',1,2,1,2,2,1,2,1,1],
  [2,2,1,1,2,1,2,1,2,1,2,1,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',1,2,1,2,1,2,2,1,1],
  [2,2,1,1,2,1,2,1,2,1,1,2,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',1,1,2,2,1,2,2,1,1],
  [2,2,1,1,2,1,2,1,2,1,1,2,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',1,1,2,2,2,1,2,1,1],
  [2,2,1,1,2,1,2,1,2,1,1,2,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',1,2,1,2,1,2,2,1,1],
  [2,2,1,1,2,1,2,1,2,1,1,2,1,2,2,1,'*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*','*',1,2,1,2,2,1,2,1,1]
];
...
const isThisWhatYouWant = async (page) => {
  ...
  for (let shouldMatch of SHOULD_MATCH_LIST) {
    for (let [index, shouldMatchNumber] of shouldMatch.entries()) {
      // TODO: 정답인 경우에 푸시하는 로직 공통처리 가능한지 확인
      if (shouldMatchNumber === '*') {
        result.push(true);
        continue;
      }
